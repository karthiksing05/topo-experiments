...
#SBATCH --output=/storage/home/hcoda1/3/ksingara3/scratch/topo-experiments/scripts/logs/train_resnet_baseline-%j.out
#SBATCH --error=/storage/home/hcoda1/3/ksingara3/scratch/topo-experiments/scripts/logs/train_resnet_baseline-%j.err

# ResNet-18 baseline (CrossEntropy only) on ImageNet (FFCV).
...
echo "=========================================="
echo "  ResNet-18: Baseline / CrossEntropy only (FFCV)"
echo "=========================================="
...
srun python -u src/imagenet/train_resnet_baseline.py \
    --config      "${CONFIG_FILE}" \
...
echo "  outputs/train_resnet_imagenet/checkpoints/best_baseline.pt"
echo "=========================================="
