#!/bin/bash
#SBATCH --job-name=resnet_topo_only
...
#SBATCH --output=/storage/home/hcoda1/3/ksingara3/scratch/topo-experiments/scripts/logs/train_resnet_topo_only-%j.out
#SBATCH --error=/storage/home/hcoda1/3/ksingara3/scratch/topo-experiments/scripts/logs/train_resnet_topo_only-%j.err

# ResNet-18 + TopoLoss only (no entropy penalty) on ImageNet (FFCV).
...
echo "=========================================="
echo "  ResNet-18: TopoLoss only (FFCV)"
echo "=========================================="
...
srun python -u src/imagenet/train_resnet_topo_only.py \
    --config      "${CONFIG_FILE}" \
...
echo "  outputs/train_resnet_imagenet/checkpoints/best_topo_only.pt"
echo "=========================================="
