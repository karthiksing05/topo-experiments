#!/bin/bash
#SBATCH --job-name=stl_cifar_topo_only
...
#SBATCH -o /storage/home/hcoda1/3/ksingara3/scratch/topo-experiments/scripts/logs/stl_cifar_topo_only_%j.out
#SBATCH -e /storage/home/hcoda1/3/ksingara3/scratch/topo-experiments/scripts/logs/stl_cifar_topo_only_%j.err
...
echo "======================================================="
echo "  Job: stl_cifar_topo_only"
echo "  Date: $(date)"
echo "  Node: $(hostname)"
echo "  GPU:  $(nvidia-smi --query-gpu=name --format=csv,noheader 2>/dev/null || echo 'N/A')"
echo "======================================================="

python src/stl_cifar/train_stl_cifar_topo_only.py \
